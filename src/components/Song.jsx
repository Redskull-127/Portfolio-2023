    ...
    return (
        <>
            <iframe
                ...
                width={750}
            ></iframe>
            <div className="absolute top-14 left-[64%] cursor-pointer">
                {songUrl && isPlaying ? (
            ...
            <Link href="https://open.spotify.com/user/to6rms2g0fzerpkwox1k4v33w" target={"_blank"} className="absolute top-14 left-[67%] cursor-pointer">
                <Spotify />
            </Link>
            {songUrl != "" && (
                <audio
